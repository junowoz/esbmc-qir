...
static const char *const extensions_qir[] = {"qir", nullptr};
...
static const language_desct language_desc_qir = {"QIR", extensions_qir};
...
static const language_desct *language_desc(language_idt id)
{
  ...
  case language_idt::QIR:
    return &language_desc_qir;
  }
  return nullptr;
}
